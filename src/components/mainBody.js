        ...
        {myWorksList.map((work)=>(
          <div className="work-item" key={work.name}>
            ...
            <div className="work-description">{work.description}
              ...
              {(work.githubRepo2)
              ?<p className="backend-description"><a href="https://github.com/navillan/js990project" target="_blank" rel="noopener noreferrer">Here</a> you can find the same project with it's own backend.</p>
              : null}
            </div>            
